...
module Send_Data
	...
	def map_message(map_id, message, player_id, color_id = Enums::Chat::MAP)
		buffer = Buffer_Writer.new
	...
	def global_message(message, color_id = Enums::Chat::GLOBAL)
		buffer = Buffer_Writer.new
		buffer.write_byte(Enums::Packet::CHAT_MSG)
		buffer.write_byte(color_id)
		buffer.write_string(message)
	...
	def guild_message(client, message, color_id = Enums::Chat::GUILD)
