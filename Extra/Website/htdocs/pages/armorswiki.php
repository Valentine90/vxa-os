		...
		<tr class="a<?php echo $n; ?>">
			...
			<td>
				...
				foreach ($json2 as $registro2) :
					if (@$registro2->drop_items[0]->kind == 3 and @$registro2->drop_items[0]->data_id == @$registro->id) {
						echo "<a href='/monster/" . @$registro2->name . "'>" . @$registro2->name . "</a><br>";
					}

					if (@$registro2->drop_items[1]->kind == 3 and @$registro2->drop_items[1]->data_id == @$registro->id and @$registro2->drop_items[1]->data_id != @$registro2->drop_items[0]->data_id) {
						echo "<a href='/monster/" . @$registro2->name . "'>" . @$registro2->name . "</a><br>";
					}
					if (@$registro2->drop_items[2]->kind == 3 and @$registro2->drop_items[2]->data_id == @$registro->id and @$registro2->drop_items[2]->data_id != @$registro2->drop_items[1]->data_id) {
						echo "<a href='/monster/" . @$registro2->name . "'>" . @$registro2->name . "</a><br>";
					}
				endforeach;
